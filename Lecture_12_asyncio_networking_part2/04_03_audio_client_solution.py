...
async def run():
    ...
    # STUDENT TASK: Add an argument '--room' for specifying the room name.
    # START SOLUTION
    ...
    # Read the room name from the arguments.
    room_name = args.room
    ...
    # STUDENT TASK: Write a line containing the room name to the server.
    # START SOLUTION
    writer.write(room_name.encode())
    writer.write(b"\n") # Write a newline symbol.
    # END SOLUTION
